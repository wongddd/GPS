...
import com.yyt.trackcar.ui.base.BasePhotoFragment;
import com.yyt.trackcar.ui.widget.imageview.preview.MediaLoader;
...
public class PreviewActivity extends FragmentActivity {
    ...
    private void initView() {
        ...
        if (mType == PreviewBuilder.IndicatorType.Dot) {
            ...
            if(mImgUrls.size() > 0) {
                PhotoBean photoBean = (PhotoBean) mImgUrls.get(mCurrentIndex);
                mTvTime.setText(TimeUtils.formatUTCC(photoBean.getCreatetime(), "yyyy/MM/dd HH:mm"));
            }
            mViewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
                ...
                public void onPageSelected(int position) {
                    ...
                    if (mTvTime != null) {
                        PhotoBean photoBean = (PhotoBean) mImgUrls.get(position);
                        mTvTime.setText(TimeUtils.formatUTCC(photoBean.getCreatetime(),"yyyy/MM/dd HH:mm"));
                    }
