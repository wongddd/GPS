 ...
 * @ author:        QING
 * @ createTime:    2020-03-02 16:35
 * @ describe:      TODO 显示网页页面
 */
@Page(name = "Web", params = {CWConstant.URL, CWConstant.TITLE})
...
//                .setMainFrameErrorView(R.layout.agentweb_error_page, -1)
    ...
    public void onDestroy() {
        EventBus.getDefault().post(new PostMessage(TConstant.NOTIFY_PARENT_VIEW_TO_FINISH));
