...
package com.yyt.trackcar.ui.widget.webview;
...
public class UIController extends AgentWebUIControllerImplBase {
    ...
    @Override
    public void onSelectItemsPrompt(WebView view, String url, String[] items,
     ...
     */
   /* @Override
    public void onSelectItemsPrompt(WebView view, String mUrl, String[] ways, final Handler
    .Callback callback) {
        ...
        final AlertDialog mAlertDialog = new AlertDialog.Extra(mActivity)//
                .setSingleChoiceItems(ways, -1, new DialogInterface.OnClickListener() {
                    ...
                    public void onCancel(DialogInterface dialog) {
                        dialog.dismiss();
                        if (callback != null) {
                            callback.handleMessage(Message.obtain(null, -1)); //-1表示取消
                            //最后callback一定要回调
                        }
                    }
                }).create();
