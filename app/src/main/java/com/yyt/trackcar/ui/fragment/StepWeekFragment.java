 ...
 * @ fileName:      StepWeekFragment
 * @ author:        QING
 * @ createTime:    6/18/21 17:19
 * @ describe:      TODO
 */
@SuppressLint("NonConstantResourceId")
@Page(name = "StepWeek", anim = CoreAnim.none)
public class StepWeekFragment extends BaseFragment {
    ...
    private void initCharts() {
        ...
        mBcStep.setMaxVisibleValueCount(7);
        ...
        mBcStep.getXAxis().setLabelCount(7);
    ...
    private void getStepList() {
        ...
        if (userModel != null && deviceModel != null) {
            ...
            CWRequestUtils.getInstance().getStepList(getContext(), userModel.getToken(),
                    deviceModel.getD_id(), deviceModel.getImei(), startWeekTime, endTime, mHandler);
        }
    }
...
//                                initStepWeek(resultBean.getList());
