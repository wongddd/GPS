...
//        initToolBar(R.string.home_history, R.drawable.ic_back_white, mNavigationOnClickListener);
        initToolBar(String.format("%s%s", getString(R.string.pet_real_time),
                getString(R.string.home_history)), R.drawable.ic_back_white, mNavigationOnClickListener);
        initViews();
        initDatas();
        initItems();
        initTabLayout();
    ...
    protected void initDatas() {
        mStartDateBtn.setText(TimeUtils.formatUTC(System.currentTimeMillis(), "yyyy/MM/dd " +
                "00:00:00"));
        mEndDateBtn.setText(TimeUtils.formatUTC(System.currentTimeMillis(), "yyyy/MM/dd HH:mm:ss"));
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                switch (tab.getPosition()) {
                    case 0: // 今天
                        ...
                        mStartDateBtn.setText(TimeUtils.formatUTC(System.currentTimeMillis(),
                                "yyyy/MM/dd 00:00:00"));
                        mEndDateBtn.setText(TimeUtils.formatUTC(System.currentTimeMillis(),
                                "yyyy/MM/dd HH:mm:ss"));
                        break;
                    case 1: // 昨天
                        mStartDateBtn.setEnabled(false);
                        mEndDateBtn.setEnabled(false);
                        mStartDateBtn.setText(AAATimeUtils.getYesterday("yyyy/MM/dd 00:00:00"));
                        mEndDateBtn.setText(AAATimeUtils.getYesterday("yyyy/MM/dd 23:59:59"));
                        break;
                    case 2: // 自定义
    ...
    protected void initItems() {
        mTabItemList.add(new BaseItemBean(getString(R.string.today)));
        mTabItemList.add(new BaseItemBean(getString(R.string.yesterday)));
        mTabItemList.add(new BaseItemBean(getString(R.string.custom)));
    }
    ...
    private void initTabLayout() {
        for (int i = 0; i < mTabLayout.getTabCount(); i++) {
            ...
            if (tab != null && mTabItemList.size() > i)
                tab.setText(mTabItemList.get(i).getContent());
        }
    }
    ...
    public void onSearch(View v) {
        ...
        if (mDeviceModel != null) {
            ...
            String endTime = TimeUtils.formatUTC(TimeUtils.formatUTC
                    ...
                    "yyyy-MM-dd HH:mm:59");
            CarGpsRequestUtils.getHistoryLocation(userModel, mDeviceModel.getDeviceImei(),
                        ...
                        if (msg.obj == null)
                            ...
                            if (responseBean.getCode() == TConstant.RESPONSE_NET_ERROR)
                                ...
                                if (listResponseBean == null || listResponseBean.getList() == null
                                    ...
                                    bundle.putInt(TConstant.DEVICE_TYPE,
                                            mDeviceModel.getDeviceType());
