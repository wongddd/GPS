...
package com.yyt.trackcar.utils.sdkinit;
...
//        //设置网络请求的全局基础地址
//        XHttpSDK.setBaseUrl(CWConstant.IP);
//        //设置动态参数添加拦截器
...
//        XHttpSDK.addInterceptor(new CustomExpiredInterceptor());
    ...
    private static void initXAOP(Application application) {
        ...
        // XAOP.setOnPermissionDeniedListener(permissionsDenied -> XToastUtils.error(String
        // .format(application.getString(R.string.permissions_error_prompt), AAAStringUtils
        // .listToString(permissionsDenied, ","))));
    }
