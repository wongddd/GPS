...
public class OPPOModelImpl implements IconBadgeNumModel {
    ...
    @Override
    public Notification setIconBadgeNum(@NonNull Application context, Notification notification,
      ...
      /*  if (true) {
        ...
        try {
            ...
            if (broadcastStarts(context, intent)) {
                context.sendBroadcast(intent);
            } else {
                try {
                    Bundle extras = new Bundle();
                    extras.putInt("app_badge_count", count);
                    context.getContentResolver().call(Uri.parse("content://com.android" +
                            ".badge/badge"), "setAppBadgeCount", null, extras);
                } catch (Throwable th) {
                }
            }
//            Bundle extras = new Bundle();
